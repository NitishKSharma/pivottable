(function () {
    ...
    //Nitish Sharma Boostrap add styling variables
    var pivot_dialog_ok_btn_class, pivot_table_btn_class, pivot_table_li_btn_class, pivot_table_td_selcted_btn_class;
  ...
  callWithJQuery(function($) {
    ...
    pivotTableRenderer = function(pivotData, opts) {
      ...
      result.className = "pvtTable table-bordered table-striped";
    ...
    $.fn.pivot = function(input, opts) {
      ...
      defaults = {
        ...
        //Nitish Sharma added options to plugin so we can pass in Bootstrap styling
        pivot_dialog_ok_btn_class: "",
        pivot_table_btn_class: "",
        pivot_table_li_btn_class: "",
        pivot_table_td_selcted_btn_class: ""
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      //Nitish Sharma defaults modified
      defaults = {
        derivedAttributes: {},
        ...
        //Nitish Sharma Bootstrap 3 styling 
        pivot_dialog_ok_btn_class: "",
        pivot_table_btn_class: "",
        pivot_table_li_btn_class: "",
        pivot_table_td_selcted_btn_class: ""
      ...
      try {
        ...
        //Nitish Sharma add option to plugin so we can pass in Bootstrap styling
        pivot_dialog_ok_btn_class = opts.pivot_dialog_ok_btn_class;
        pivot_table_btn_class = opts.pivot_table_btn_class;
        pivot_table_li_btn_class = opts.pivot_table_li_btn_class;
        pivot_table_td_selcted_btn_class = opts.pivot_table_td_selcted_btn_class;
        ...
        uiTable = $("<table>", {
          "class": "pvtUi table table-bordered table-responsive"
        }).attr("cellpadding", 5);
        rendererControl = $("<td>");
        renderer = $("<select>").addClass('form-control').appendTo(rendererControl).bind("change", function() {
          return refresh();
        });
        ref1 = opts.renderers;
        for (x in ref1) {
         ...
         //popup filter box
          ...
          valueList.append($("<h4>").text(c + " (" + keys.length + ")"));
            ...
            if (keys.length > opts.menuLimit) {
                ...
                //Nitish Sharma added Bootstrap 3 styling via plugin setting. See pivot_table_btn_class for...Select All
                btns.append($("<button class='" + pivot_table_btn_class + "'>", {
                  type: "button"
                }).html(opts.localeStrings.selectAll).bind("click", function() {
                  return valueList.find("input:visible").prop("checked", true);
            }));
            
                //Nitish Sharma added Bootstrap 3 styling via plugin setting. See pivot_table_li_btn_class for...Select None
                btns.append($("<button class='" + pivot_table_li_btn_class + "'>", {
              type: "button"
            ...
            //Nitish Sharma added Bootstrap styling to input.  See class='form-control'
            btns.append($("<input class='form-control'>", {
              type: "text",
              ...
              return valueList.find('.pvtCheckContainer span').each(function() {
                var testString;
            ...
            for (o = 0, len3 = ref2.length; o < len3; o++) {
              ...
              filterItem.append($("<span>").text(" (" + v + ")"));
                ...
                //Nitish Sharma removed p tag and added Bootstrap 3 checkbox styling <span class='input-group-addon'> 
              checkContainer.append($("<span class='input-group-addon'>").append(filterItem));
            }
          }
          ...
          updateFilter = function() {
            ...
            //Nitish Sharma added boostrap btn classes pivot_dialog_ok_btn_class to OK button
          $("<p>").appendTo(valueList).append($("<button class='" + pivot_dialog_ok_btn_class + "'>", {
            type: "button"
          ...
          //Nitish Sharma added class pivot_dialog_ok_btn_class to span and removed styling from css
          triangleLink = $("<span>").addClass('pvtTriangle').html("&#x25BE;").bind("click", showFilterList);

          attrElem = $("<li>").addClass("axis_" + i).append($("<span class='" + pivot_dialog_ok_btn_class + "'>").addClass('pvtAttr').text(c).data("attrName", c).append(triangleLink));
          if (hasExcludedItem) {
            attrElem.addClass('pvtFilteredAttribute');
          }
        ...
        //Nitish Sharma added bootstrap styling to cols buttons
        $("<td>").addClass('pvtAxisContainer pvtHorizList pvtCols').appendTo(tr1);

        tr2 = $("<tr>").appendTo(uiTable);

        //Nitish Sharma added bootstrap styling to rows buttons
      ...
      barcharter = (function(_this) {
        return function(scope) {
          ...
          return forEachCell(function(x, elem) {
           ...
           //Nitish Sharma updated bar chart to Bootstrap 3 styling with rounded look, pivot_barchart_bar_class...Table Barchart color
            wrapper.append($("<div class='" + pivot_table_btn_class + "' >").css({
                "position": "absolute",
                "bottom": 0,
                "left": 0,
                "right": 0,
